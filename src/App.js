     ...
     return (
      ...
      <Chart
        ...
        data={[
          ...
          ['1', 'Design document', new Date('2022-02-13'), null, 7 * 86400000, 100, null],
          ['2', 'Design review with supervisor', null, null, 7 * 86400000, 100, '1'],
          ['3', 'CI/CD implementation', null, null, 5 * 86400000, 100, '2'],
          ['4', 'Backend implementation', null, null, 5 * 86400000, 100, '3'],
          ['5', 'Front-end implementation', null, null, 21 * 86400000, 100, '4'],
          ['6', 'Launch to Beta stage', null, null, 21 * 86400000, 100, '5'],
          ['7', 'Testing (Functional testing and load testing) + Benchmarking', null, null, 3 * 86400000, 100, '6'],
          ['8', 'Update specs of system based on benchmarking results', null, null, 3 * 86400000, 100, '7'],
          ['9', 'Documenting the System + APIs', null, null, 3 * 86400000, 100, '8'],
